...
public class FlowGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "Comment", "Assign", "While", "For", "If", "Else", "Output", "Return", 
			"IntArrayType", "BoolArrayType", "CharArrayType", "IntType", "CharType", 
			"BoolType", "VoidType", "LParen", "RParen", "Comma", "LBrace", "RBrace", 
			"Semicolon", "LCrotchet", "RCrotchet", "Plus", "Sub", "Div", "Mult", 
			"Mod", "Less", "LessEq", "Grtr", "GrtrEq", "Eq", "And", "Or", "Xor", 
			"Not", "Index", "Size", "Idfr", "IndexNum", "ComponentId", "CharLit", 
			"IntLit", "BoolLit"
		};
	}
	...
	public FlowGrammarLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "FlowGrammar.g4"; }
