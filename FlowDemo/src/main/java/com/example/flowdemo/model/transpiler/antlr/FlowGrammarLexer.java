...
public class FlowGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IntType", "CharType", "BoolType", "VoidType", "LParen", "RParen", "Comma", 
			"LBrace", "RBrace", "Semicolon", "Plus", "Sub", "Div", "Mult", "Mod", 
			"Less", "LessEq", "Grtr", "GrtrEq", "Eq", "And", "Or", "Xor", "Not", 
			"Idfr", "ComponentId", "CharLit", "IntLit", "BoolLit"
		};
	}
